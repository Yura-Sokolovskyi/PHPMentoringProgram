...
class ClientStubDecorator extends AbstractDecorator
{
    public function makeRequest($method, $uri, $options): Response
    {
        if ($method === 'GET') {
            switch ($uri) {
                case 'breeds/list/all':
                    return new Response(200, [], $this->getBreeds());
                case 'breed/hound/images/random':
                    return new Response(200, [], $this->getRandomBreedImage());
            }
        }
